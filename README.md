...
> 💡 A quota / region-unlock request is **free on any plan** via the portal (**Help + Support → New Support Request**). Quota and subscription-management requests don't require a paid Azure support plan — only technical support does.
